import best_words from './audio/best_words.mp3';
import you_will_get_bored_of_winning from './audio/you_will_get_bored_of_winning.mp3';
import when_a_star from './audio/when_a_star.mp3';
import tictacs from './audio/tictacs.mp3';
import just_kiss from './audio/just_kiss.mp3';
import moved_on_her from './audio/moved_on_her.mp3';
import furniture_shopping from './audio/furniture_shopping.mp3';
import she_was_married from './audio/she_was_married.mp3';
import look_at_him from './audio/look_at_him.mp3';
import war_hero from './audio/war_hero.mp3';
import some_form_of_punishment from './audio/some_form_of_punishment.mp3';
import dating_her from './audio/dating_her.mp3';
import take_out_their_families from './audio/take_out_their_families.mp3';
import blood_wherever from './audio/blood_wherever.mp3';
import greatest_jobs_president from './audio/greatest_jobs_president.mp3';
import great_wall from './audio/great_wall.mp3';
import mexico_pay_for_it from './audio/mexico_pay_for_it.mp3';
import my_genius_ok from './audio/my_genius_ok.mp3';
import im_not_stupid from './audio/im_not_stupid.mp3';
import unifier from './audio/unifier.mp3';
import second_amendment_people from './audio/2nd_amendment_people.mp3';
import greatest_builder from './audio/greatest_builder.mp3';
import maybe_a_rope from './audio/maybe_a_rope.mp3';
import poorly_educated from './audio/poorly_educated.mp3';
import i_will_apologize from './audio/i_will_apologize.mp3';
import part_of_the_beauty from './audio/part_of_the_beauty.mp3';
import it_could_be_warming from './audio/it_could_be_warming.mp3';
import weather_goes_up_and_down from './audio/weather_goes_up_and_down.mp3';
import no_hairspray from './audio/no_hairspray.mp3';
import i_want_hairspray from './audio/i_want_hairspray.mp3';
import a_lot_of_hoax from './audio/a_lot_of_hoax.mp3';
import i_am_your_voice from './audio/i_am_your_voice.mp3';
import i_alone from './audio/i_alone.mp3';
import the_truth from './audio/the_truth.mp3';
import no_puppet from './audio/no_puppet.mp3';
import triple_the_country from './audio/triple_the_country.mp3';
import my_tax_returns_absolutely from './audio/my_tax_returns_absolutely.mp3';
import worst_shape from './audio/worst_shape.mp3';
import greatest_voice from './audio/greatest_voice.mp3';
import i_finished_it from './audio/i_finished_it.mp3';
import we_all_wanna_get_back from './audio/we_all_wanna_get_back.mp3';
import the_founder from './audio/the_founder.mp3';
import phony_numbers from './audio/phony_numbers.mp3';
import thousands_were_cheering from './audio/thousands_were_cheering.mp3';
import rip_the_baby from './audio/rip_the_baby.mp3';
import more_respect from './audio/more_respect.mp3';
import not_looking_at_anything from './audio/not_looking_at_anything.mp3';
import i_sorta_hope from './audio/i_sorta_hope.mp3';
import strongest_asset from './audio/strongest_asset.mp3';
import winning_temperament from './audio/winning_temperament.mp3';
import inside_and_out from './audio/inside_and_out.mp3';
import rosie_fired from './audio/rosie_fired.mp3';
import sue_her from './audio/sue_her.mp3';
import unattractive_mouth from './audio/unattractive_mouth.mp3';
import very_rough from './audio/very_rough.mp3';
import punch_him from './audio/punch_him.mp3';
import on_a_stretcher from './audio/on_a_stretcher.mp3';
import tomato from './audio/tomato.mp3';
import in_court from './audio/in_court.mp3';
import much_further from './audio/much_further.mp3';
import out_out_out from './audio/out_out_out.mp3';
import shoot_somebody from './audio/shoot_somebody.mp3';
import nothing_to_say from './audio/nothing_to_say.mp3';
import very_good_brain from './audio/very_good_brain.mp3';
import better_than_anybody from './audio/better_than_anybody.mp3';
...
export default {
    ...
    a_lot_of_hoax: {
        audio: a_lot_of_hoax,
        text:
            'So Obama’s talking about all of this with the global warming and the — a lot of it’s a hoax, it’s a hoax.',
        date: '12/30/15',
        location: 'Hilton Head, SC',
    ...
    triple_the_country: {
        ...
        text:
            'You could have 650 million people pour in, and we do nothing about it ... You triple the size of our country in one week',
        date: '10/30/16',
    ...
    phony_numbers: {
        audio: phony_numbers,
        text:
            "When you hear 4.9 and 5% unemployment. The number's probably 28, 29, as high as 35. In fact, I even heard recently 42%.",
        date: '2/9/16',
    ...
    thousands_were_cheering: {
        ...
        text:
            'And I watched in NJ, where thousands and thousands of people were cheering as that building was coming down.',
        date: '11/21/15',
    ...
    i_sorta_hope: {
        audio: i_sorta_hope,
        text:
            'Real estate bubble? \n Well first of all, I sorta hope that happens, because then people like me would go in and buy.',
        date: '2006',
        location: 'CNN',
